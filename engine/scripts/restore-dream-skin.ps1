  ...
  try {
    ...
    if ($Uninstall) {
      ...
      @(
        ...
        (Join-Path $desktop 'Codex Angelina Gravity Field.lnk'),
        (Join-Path $desktop 'Codex Angelina Gravity Field - Restore.lnk'),
        (Join-Path $desktop 'Codex Angelina Gravity Field - Tray.lnk'),
        (Join-Path $startMenu 'Codex Angelina Gravity Field.lnk'),
        (Join-Path $startMenu 'Codex Angelina Gravity Field - Tray.lnk')
